        ...
        <div className="space-y-8">
          <div className="space-y-3">
            ...
            <p className="text-sm text-slate-500 leading-relaxed max-w-sm font-semibold">
              Enter your account credentials to access your designer network workspace dashboard.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 text-left">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link href="#" className="text-xs font-bold text-accent hover:text-accent/80 transition-colors">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
            ...
            <div className="flex items-center justify-between pt-1">
              <div className="flex items-center">
                <input
                  id="keep-signed"
                  type="checkbox"
                  className="h-4 w-4 rounded border-slate-300 text-primary focus:ring-accent/30 cursor-pointer"
                />
                <label htmlFor="keep-signed" className="ml-2 block text-xs text-slate-600 font-bold cursor-pointer select-none">
          ...
          <div className="flex flex-col gap-4 pt-2">
            <button
              ...
              type="button"
              className="flex w-full items-center justify-center gap-2 rounded-full border border-slate-200 bg-white px-4 py-3 text-sm font-bold text-slate-800 hover:bg-slate-50 hover:border-slate-300 transition-all duration-200"
            >
            ...
            <p className="text-center text-xs text-slate-500 font-bold">
              ...
              <Link href="/register" className="text-accent hover:text-accent/80 font-black transition-colors">
                Sign Up
              </Link>
            </p>
          </div>
